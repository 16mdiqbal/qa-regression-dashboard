...
export function TrendLineChart({ entries, folders, metricLabel, isPercentage, width, height }: TrendLineChartProps) {
  ...
  return (
    <LineChart width={width} height={height} data={rows} margin={{ top: 8, right: 24, bottom: 8, left: 8 }}>
